...
"Present_Characters": "A array of strings containing only the exact, clean names of characters in the scene (e.g., \`\${kidName}\`, \`\${character1}\` ). This field MUST NOT include any descriptive text, apparel details, or brackets. For character-free scenes, this array must be empty: []. **Correct:** [\"Tyler\", \"Pengu\"]. **Incorrect:** [\"Tyler [wearing a hoodie]\", \"Pengu\"]"
  ...
  "Key_Visual_Elements": "An array of 1-2 iconic objects or symbols from the story that hint at the narrative. The moral symbol must be one of these elements. E.g., ['1. The moral symbol, the glistening rainbow-colored seed, is held by \`\${kidName}\` and glows softly.', '2. A mysterious, sparkling vine grows in the background, disappearing into the clouds.']",
...
\`\`\`json
{
  "scene_description": {
    ...
    "Key_Storytelling_Props": "1. A large, ancient-looking star-chart on the floor. 2. The moral symbol: 'The Star-Key' (a silver key with two interlocking stars at its head, representing the moral 'Teamwork can solve any riddle') lies beside the chart.",
